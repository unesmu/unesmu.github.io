...
Aggregating the data this way shows furthermore that there is an inscrease in the number of quotes with negative sentiment around the end of 2017
...
<p align = "center">
	<small> 
		<i> 
			<b>
			Fig.2.5 - Bootstrapped confidence intervals for the sentiment scores per year for the positive, negative and neutral categories
			</b> 
		</i>
	</small>
</p>
