...
While these might not be entirely representative (see the comments about observational data), and that we can't exclude the possibility of a confounder we can still note some interesting features. First, the context of the quotations, in this case the date, allows us to infer more meaning to quotes. Another interesting features is that this reverse design might me more useful to determine what are the important events that shape feminist discussion in news articles. Indeed, 100 quotes in the 5,099 quotes of the negative quotes of the period of interest mention Trump directly. One interpretation could be that a lot of people prefer adressing the question in general term, than directly mentionning him as a sexual offender due to his position of power. It could also be that this scandal lead to more discussions related to the topic of sexual violences. But we will let this as an exploration for the reader...
