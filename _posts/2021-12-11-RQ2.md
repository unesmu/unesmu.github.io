...
Based on these observation we can conclude that opinions are equally distributed over positive and negative opinions [(P<0.05)][^1]. No shift towards one side or the other can be demonstrated overall. We can conclude that overall in news article there isn't any tendency towards speaking more frequently in good or bads term about gender euqlaity questions. For further analysis we will compare how sentiment scores differ from this reference state. 

[^1]: A chi-square test with a null hyptothesis of equally distributed proportion can be found in the main notebook.

The medians indicates positive and negative opinions have the same strength, i.e. the negative quotations aren't more negative than the positive ones. So overall, the underlying distribution of positive and negative quotations are similar [(P<0.05)][^w]
[^1]: A chi-square test with a null hyptothesis of equally distributed proportion can be found in the main notebook.
